...
public class SampleDataUtil {
    ...
    private static Patient patientAlex =
        new Patient(new Name("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh" + "@example" + ".com"),
            new Address("Blk 30 Geylang Street 29, #06-40"), getTagSet("friends"), new MedicalHistory("lovesick"));


    public static Patient[] getSamplePersons() {
        return new Patient[]{patientAlex,
    ...
    public static Appointment[] getSampleAppointments() {
        return new Appointment[]{new Appointment(SampleDataUtil.getSamplePersons()[0], "2020-10-17")};
    }
