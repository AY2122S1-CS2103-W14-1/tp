...
public class AddAppointmentCommandParserTest {
    ...
    @Test @Disabled("Currently, parser do not discard unused preamble") public void parse_allFieldsPresent_success() {
    ...
    @Test public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_PATIENT_ID_0 + VALID_APPOINTMENT_DATE_TIME_DESC, expectedMessage);

        // missing date time prefix
        assertParseFailure(parser, VALID_PATIENT_ID_DESC_0 + VALID_APPOINTMENT_DATE_TIME, expectedMessage);


        // all prefixes missing
        assertParseFailure(parser, VALID_PATIENT_ID_0 + VALID_APPOINTMENT_DATE_TIME, expectedMessage);
    }

    @Test @Disabled("Currently, no error checking is done for patient id and date time")
    public void parse_invalidValue_failure() {
        ...
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + VALID_PATIENT_ID_DESC_0 + VALID_APPOINTMENT_DATE_TIME_DESC,
